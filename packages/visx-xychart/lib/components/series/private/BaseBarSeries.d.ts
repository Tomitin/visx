...
} & Pick<BarsProps<XScale, YScale>, 'radius' | 'radiusAll' | 'radiusTop' | 'radiusRight' | 'radiusBottom' | 'radiusLeft' | 'BarComponent'>;
...
} & Pick<BarsProps<import("@visx/scale").ValueOf<import("@visx/scale").ScaleTypeToD3Scale<import("@visx/axis").AxisScaleOutput, any, any>>, import("@visx/scale").ValueOf<import("@visx/scale").ScaleTypeToD3Scale<import("@visx/axis").AxisScaleOutput, any, any>>>, "radius" | "radiusAll" | "radiusTop" | "radiusRight" | "radiusBottom" | "radiusLeft" | "BarComponent"> & Pick<import("../../../types").DataContextType<import("@visx/scale").ValueOf<import("@visx/scale").ScaleTypeToD3Scale<import("@visx/axis").AxisScaleOutput, any, any>>, import("@visx/scale").ValueOf<import("@visx/scale").ScaleTypeToD3Scale<import("@visx/axis").AxisScaleOutput, any, any>>, object>, "xScale" | "yScale">, "radius" | "radiusAll" | "radiusTop" | "radiusRight" | "radiusBottom" | "radiusLeft" | "BarComponent" | "BarsComponent" | "barPadding" | "colorAccessor">) => JSX.Element | null;
