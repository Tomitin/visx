...
var _excluded = ["bars", "BarComponent", "horizontal", "xScale", "yScale", "radius", "radiusAll", "radiusTop", "radiusRight", "radiusBottom", "radiusLeft"],
  _excluded2 = ["key"];
...
function Bars(_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, bars.map(function (_ref2) {
    ...
    return BarComponent ? /*#__PURE__*/_react.default.createElement(BarComponent, _extends({}, barProps, restProps, {
      key: key,
      className: "visx-bar",
      tabIndex: isFocusable ? 0 : undefined
    })) : radius == null ? /*#__PURE__*/_react.default.createElement(_shape.Bar, _extends({
      key: key,
      tabIndex: isFocusable ? 0 : undefined
